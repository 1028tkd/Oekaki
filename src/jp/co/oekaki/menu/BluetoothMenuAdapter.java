 ...
 * @param dipWidth 画面幅
 *===========================================================================================================*/
class BluetoothMenuAdapter extends BaseAdapter {
	...
	public BluetoothMenuAdapter(List<MenuItem> mMenuItems,LayoutInflater mInflater) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.bluetooth_list_item_withimg, null);
